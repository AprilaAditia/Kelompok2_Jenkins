                        ...
                        <table class="table table-light">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>:
                                        {{ \Carbon\Carbon::parse($model->tanggal_bayar)->locale('id')->translatedFormat('d F Y H:i') }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:
                                        {{ \Carbon\Carbon::parse($model->tanggal_konfirmasi)->locale('id')->translatedFormat('d F Y H:i') }}
                                    </td>
                                </tr>
                            </thead>
                        </table>
